...
Command.persistence = main.enum.Persistence.UntilPlayerRespawns -- when set to 'None', the command will revoke after being invoked - to change this, replace 'None' with 'UntilRevoke', UntilPlayerDies', 'UntilPlayerRespawns', 'UntilPlayerLeaves', 'UntilCallerLeaves' or 'UntilPlayerOrCallerLeave'
