...
1) If every argument for the command has playerArg ~= true then returns RequiredQualifier.Never

2) If even one argument for the command has playerArg == true and hidden ~= true returns
	RequiredQualifier.Always

3) If condition (1) and condition (2) are not satisfied, meaning every argument for 
	the command has playerArg == true and hidden == true returns RequiredQualifier.Sometimes
